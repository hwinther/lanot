...
cp -v ports/esp32/build-ESP32_MICROWSH_C6/firmware.bin ../../deploy/micropython/esp32/ESP32_MICROWSH_C6-$mpyversion-p$prometheus_version-$mpybuilddate.bin
